...
<div markdown="1">
    <ul>
      <br><li>2022년 8월 변경사항 : SWEA에 존재하는 D1, D2 문제(총 44문제)를 일주일에 5문제씩 해결합니다.~~</li>
      <br><li>2022년 9월 변경사항 : 다양한 알고리즘 문제 사이트에 존재하는 IM형 문제(필수), A형 문제(선택)들을 일주일에 2~3문제(IM형 1~2문제, A형 1문제)씩 해결합니다.</li>
...
|                                            문제 이름                                             | 난이도 | 발표자 및 풀이 |
| :----------------------------------------------------------------------------------------------: | :----: | :------------: |
|                    [[BOJ] 14501. 퇴사](https://www.acmicpc.net/problem/14501)                    |   S3   |                |
|                 [[BOJ] 15686. 치킨 배달](https://www.acmicpc.net/problem/15686)                  |   G5   |                |
| [[Programmers] 92342. 양궁대회](https://school.programmers.co.kr/learn/courses/30/lessons/92342) |  LV2   |                |
