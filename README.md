...
<div markdown="1">
    <ul>
      <br><li><b>8월 :</b> SWEA에 존재하는 D1, D2 문제(총 44문제)를 일주일에 5문제씩 해결합니다.</li>
      <br><li><b>9월 :</b> 다양한 알고리즘 문제 사이트에 존재하는 IM형, A형 문제를 일주일에 2~3문제(A형 문제 1개, IM형 문제 1~2개)씩 해결합니다.</li>
...
<div markdown="1">
    <ul>
      ...
      <img src="https://user-images.githubusercontent.com/89143804/187966303-28042514-89a0-40d8-8270-db49733bdaf4.png" alt="structure_of_folder">
    </ul>
  </div>
</details>
      ...
      <ul>
        ...
        <b>타입의 종류</b><br/><br/>
          <ul>
            ...
            <li>Docs: README.md 또는 코드 주석 수정</li>
...
| 문제 번호 |                                                문제 이름                                                 |      난이도       |  발표자(1팀)   | 풀이(1팀) |  발표자(2팀)   | 풀이(2팀) |
| :-------: | :------------------------------------------------------------------------------------------------------: | :---------------: | :------------: | :-------: | :------------: | :-------: |
|   1952    | [수영장](https://swexpertacademy.com/main/code/problem/problemDetail.do?contestProbId=AV5PpFQaAQMDFAUq&) |     SWEA - D4     | 김태학, 이강윤 |           | 양희제, 오태훈 |           |
|   2635    |                           [수 이어가기](https://www.acmicpc.net/problem/2635)                            |     BOJ - S5      | 이기용, 게스트 |           | 김도언, 조용현 |           |
|   42888   |              [오픈채팅방](https://school.programmers.co.kr/learn/courses/30/lessons/42888)               | PROGRAMMERS - LV2 | 양희제, 박진성 |           | 송대현, 유덕균 |           |
